...
summary: |-
  ...
  DECISION:[2026-06-17]缺陷1已修(附餐帶qty,middleItemLine+SideDishLineTest,實機驗),缺陷2(孤兒隱形)經確認為設定問題已排除非bug｜[2026-06-26]新增缺陷3(附餐調味加料未顯示,實機03單附餐辣/多麵少麵卡片不出)→Issue重啟,缺陷3待修
related:
  - "[[Systems/訂單卡片元件]]"
---
# ISSUE：附餐顯示缺陷
...
- [ ] **缺陷 3：待修**（2026-06-26 發現）。附餐渲染補上調味加料，與主項/列印對齊。
